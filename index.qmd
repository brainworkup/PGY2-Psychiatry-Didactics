...
## Behavioral/Emotional/Social/Personality
...
- Child Autism Rating Scale, 2nd ed (CARS-2)
- Autism Diagnostic Observation Schedule, 2nd ed (ADOS-2)


## Effort/Validity Testing
Crucial for interpreting test results and ensuring accurate clinical conclusions


### Symptom Validity Tests (SVTs)
- Positive Impression ("everything is perfect")
- Negative Impression ("everything is wrong")
- Atypical/Infrequent Responses
...
# Measurement/Objectivity/Interpretation
...
{{< value-box value="100" unit="%" label="Progress" icon="up" colour="success" >}}
